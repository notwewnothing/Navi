...
class AppBlocker {
  static const _channel = MethodChannel('navi/app_blocker');
  ...
  static Future<void> setBlockRules(List<String> rules) async {
    if (!isSupported) return;
    try {
      await _channel.invokeMethod<void>('setBlockRules', {'rules': rules});
    } on MissingPluginException {
      return;
    } on PlatformException {
      return;
